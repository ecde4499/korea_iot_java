...
class CarClass {
    int a ;
    // cf) 매서드명 - 동일한 스코프 내에서 같은 변수명 사용 O

    // 1. 필드(속성)
    // 1) 인스턴스 필드: 각 개체마다 다른 값을 가짐
    String brand;
    String color;
    int speed;
