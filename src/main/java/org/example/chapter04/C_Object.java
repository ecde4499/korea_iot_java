...
class Car {
    ...
    // - 클래스의 속성(필드)를 사용하여 특정 작업을 수행 하거나 해당 값을 변경 또는 반환 가능
    /*
        == 메서드의 구조 ==
        반환타입 메서드명(매개변수...) {
            메서드의 동작을 정의
    ...
    void displayInfo() { // lowerCamelCase (변수명과 동일)
        ...
        System.out.println("모델 : " + model + " 제조 연도 : " + year);
    }
...
public class C_Object {
    public static void main(String[] args) {
        ...
        Car car = new Car("volvo XC60", 2025);
        System.out.println(car); // org.example.chapter04.Car@3b07d329

        System.out.println();
        // == 객체 사용 == //
        //.연산자 사용 - 객체내부의 필드와 메서드를 사용
