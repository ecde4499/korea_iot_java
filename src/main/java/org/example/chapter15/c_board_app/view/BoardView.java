            ...
            try {
                ...
                switch (choice) {
                    ...
                    case 2: {
                        ...
                        List<BoardResponseDto> dtos = boardController.getAllBoard();
                    ...
                    case 4: {
                        ...
                        BoardRequestDto requestDto = new BoardRequestDto(title, content, "수정은 작성자 X");
                        // BoardCreateRequestDto (title, content, author)
                        // BoardUpdateRequestDto (title, content)
                        boardController.updateBoard(updatedId, requestDto);
                        break;
                    }
                    case 5: {
