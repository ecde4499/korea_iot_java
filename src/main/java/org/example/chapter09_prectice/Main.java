...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("조회 실패: " + e.getMessage()); // 조회 실패: 사용자 ID 목록에 100값이 없습니다.
        }
        ...
        try {
            ...
            userService.getUserById(1); // 삭제 실패: 사용자 ID 목록에 1값이 없습니다.
        } catch (UserNotFoundException e) {
        ...
        // 특정 이름 조회 (필터링)
        String search = "이승민";
        List<User> filteredUsers = userService.findUsersByName(search);

        System.out.println("\n[" + search + "] 이름으로 조회된 사용자 목록 : ");
