...
// == 도서 관리 시스템 == //
// : 책의 정보를 저장, 책의 상태(대여 다능 여부) 확인, 책의 정보 출력

// 1) Book 클래스
// : 속성) title(Sting, 불면성), author(String, 블면성), isAvailable(boolean)
// : 메서드) borrowBook(), retundBook(), displayInfo()
...
class Book {
    ...
    void borrowBook() {
        if (isAvailable) {
            ...
            System.out.println("현재 대여중입니다. (대여불가)");
        }
    }
    ...
    void returnBook() {
        ...
        } else System.out.println("이미 반납된 상태입니다. (반납불가)");
    }
