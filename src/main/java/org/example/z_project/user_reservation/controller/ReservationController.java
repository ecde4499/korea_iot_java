...
import org.example.z_project.user_reservation.service.implment.ReservationServiceImpl;
import org.example.z_project.user_reservation.service.implment.UserServiceImpl;
...
public class ReservationController {
    ...
    private int getChoice(Scanner sc) {
        while (!sc.hasNextInt()) {
            // hasNextInt()
            // : 입력값이 int면 ture, 그렇지 않으면 false 반환
