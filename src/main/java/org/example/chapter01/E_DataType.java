...
public class E_DataType {
    public static void main(String[] args) {
        ...
        // byte : -128 ~ -127
        // short : 332,768 ~ 32,767
        // int : 약 -2.1억 ~ 약 2.1억
        // lont : 약 -2의 63제곱 ~ 약 2의 63제곱

        byte byteValue = 127;
        short shoryValue = 32767;
        int intValue = 987239874;
        long longValue = 12312312312L; // Long 타입은 숫자 뒤에 알파벳 L, l을 써서 표기(대문자 권장)
        ...
        char grade = 'A';
        char lastName = '이'; // "이" 불가 - 쌍따옴표 사용 금지!
        char gander = '남'; // 단일 문자만 저장 가능 ('남자' 불가)
        ...
        // : 실제 데이터 값이 저장되는 것이 아닌 데이터가 저장된 주소값을 가지는 자료형
