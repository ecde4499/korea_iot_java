...
/*
    ...
    2) 언박싱
    : Wrapper 클래스의 객체 => 기본타입으로 변환

    +) 장단점
        - 장정: 기본 타입과 객체 타입 간의 호환이 용이
...
public class A_Wrapper {
    public static void main(String[] args) {
        ...
        // System.out.println(parseInt2); // NumberFormatException
        ...
        System.out.println(result); // -1 (값이 더 작음) - 값이 같으면 0, 비교한 값보다 크면 1
