...
public class StudentManagementApp {
    ...
    //      : 하나의 파일에서 public 단위 클래스는 한 개만 지정 가능
    ...
    static void updateStudentGap(int studentId, double newGpa) {
        for (Student student: students) {
            if (student.studentId == studentId) {
    ...
    // main 메서드
    // : 프로그램 진입점을 제공
    // => public static void mains(String[] args) {} 형식이여야 만 실행 가능
    ...
    public static void main(String[] args) {
        ...
        // 학생 평점 업데이트
        updateStudentGap(2, 4.1);
        updateStudentGap(4, 4.5);
