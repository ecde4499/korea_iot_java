...
public class JavaLang {
    public static void main(String[] args) {
        ...
        MyClass myClass = new MyClass(1, "이승아");
        System.out.println(myClass); // MyClass [ID: 1 | NAME: 이승아]
        System.out.println(myClass.toString()); // MyClass [ID: 1 | NAME: 이승아]
        System.out.println(myClass.displayInfo()); // MyClass [ID: 1 | NAME: 이승아]

        MyClass myClass2 = new MyClass(2, "이도경");

        // equals() 메서드
        // : 인스턴스 메서드
        System.out.println("myClass과 myClass2의 비교: " + myClass.equals(myClass2)); // false

        MyClass myClass3 = myClass;

        System.out.println("myClass과 myClass2의 비교: " + myClass.equals(myClass3)); // true
        ...
        System.out.println(massage.substring(6,15)); // Christmas

        System.out.println(massage); // Merry Christmas! - 문자열 기능을 활용해도 기본 데이터 변환 X
        // => 문자열의 불변성
