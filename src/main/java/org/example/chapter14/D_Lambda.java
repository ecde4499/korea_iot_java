...
public class D_Lambda {
    public static void main(String[] args) {
        ...
        System.out.println("람다식 결과1: " + calculator2.add(4, 9)); // 13


        // cf) 람다식의 경우 구현부가 한 줄 일때 중괄호 생략 가능
        //  => return 키워드까지 생략! (값은 곧바로반환)
        Calculator calculator3 = (a, b) -> a + b;
        System.out.println("람다식 결과2: " + calculator3.add(7, 8)); // 15
        System.out.println();
        ...
        OneParams oneParams1 = massage -> System.out.println("출력: " + massage);
        oneParams1.print("안녕");
        System.out.println();
        ...
        System.out.println();
        numbers.forEach(num -> System.out.print(num + " ")); // 10 20 30
    }
}
