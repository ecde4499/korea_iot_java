...
/*
    ...
    : 메서드
        ...
        - compose(Function before): 다른 Function의 결과를 련재 입력으로 연결
...
public class E_Lambda {
    public static void main(String[] args) {
        ...
        Consumer<String> printMassage = msg -> System.out.println(msg);
        Consumer<String> printLength = msg -> System.out.println(msg.length());

        printMassage.accept("안녕하세요 :)"); // 안녕하세요 :)
        printLength.accept("1234567"); // 7

        Consumer<String> combinedConsumer = printMassage.andThen(printLength);
        ...
        // Math.random(): 0.0과 1.0 사이에 무작위 실수를 반환
