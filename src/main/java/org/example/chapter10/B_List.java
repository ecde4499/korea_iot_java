...
// 1. 특징
// : 순서 유지(인덱스를 통해 정확한 위치 지정이 가능), 중복 저장 가능
...
public class B_List {
    public static void main(String[] args) {
        ...
        System.out.println(startTime); // 5738985764500
        ...
        System.out.println("ArrayList 삽입 시간: " + (endTime - startTime) + "ns"); // ArrayList 삽입 시간: 2083299100ns
        ...
        for (int i = 0; i < 222222; i++) {
            linkedListTest.add(0,1);
        }

        endTime = System.nanoTime();

        System.out.println("LinkedList 삽입 시간: " + (endTime - startTime) + "ns"); // LinkedList 삽입 시간: 6615200ns
