...
public class InventorySystem {
    public static void main(String[] args) {
        LibraryManager libraryManager = new LibraryManager(); // 도서 관리 시스템을 인스턴스화
            ...
            try {
                ...
                switch (choice) {
                    case 1:
                        ...
                        libraryManager.add(new Book(id, title, isbn, author, publisher, year, price, stock, category));
                        break;

                    case 2:
                        libraryManager.listAll();
                        break;
                    ...
                    case 3:
                        ...
                        libraryManager.updateStock(updateId, quantity);
                        break;

                    case 4:
                        System.out.println("Enter Book ID ot remove");
                        String removeId = sc.nextLine();
                        libraryManager.remove(removeId);
                        break;
                    ...
                    case 5:
                        ...
                        List<Item> searchResult = libraryManager.search(keyword);
                    ...
                    case 6:
                        ...
                        List<Item> categoryResult = libraryManager.searchByCategory(searchCategory);
                    ...
                    case 7:
                        ...
                        List<Item> priceResult = libraryManager.searchByPrice(minPrice, maxPrice);
