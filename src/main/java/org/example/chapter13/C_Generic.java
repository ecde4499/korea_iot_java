...
public class C_Generic {
    public static void main(String[] args) {
        ...
        furnitures.add(new Furniture("침대", 100));
        furnitures.add(new Furniture("쇼파", 60));
        furnitures.add(new Furniture("화장대", 50));

        double totalFurniture = DiscountPolicy.applyDiscount(furnitures, 0.2);
        System.out.println("총 가구 할인액: " + totalFurniture + "원"); // 총 가구 할인액: 42.0원
    }
}
